...
الداخل الجديد وصاعدي الترتيب. صفقة لا تُدار ليست قياساً ناقصاً بل ليست قياساً أصلاً،
واكتشاف عملة جديدة لا يسبق ذلك. وإن استنفدت المراكز وحدها الميزانية فالدورة تسجّل
تحذيراً صريحاً، لأن الاكتشاف يكون قد توقف.
